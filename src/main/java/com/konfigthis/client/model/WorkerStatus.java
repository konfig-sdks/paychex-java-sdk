 ...
 */
@ApiModel(description = "The state representation of allowed worker statuses configured for the company.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkerStatus {
  ...
  public WorkerStatus workerStatusId(String workerStatusId) {
  ...
  **/
  ...
  public WorkerStatus statusType(String statusType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ACTIVE", value = "The status category.")
  ...
  public WorkerStatus statusReason(String statusReason) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "HIRED", value = "The reason of the status.")
  ...
  public WorkerStatus links(List<Link> links) {
  ...
  public WorkerStatus addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
   ...
   * @return the WorkerStatus instance itself
   */
  public WorkerStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.workerStatusId, workerStatus.workerStatusId) &&
        Objects.equals(this.statusType, workerStatus.statusType) &&
        Objects.equals(this.statusReason, workerStatus.statusReason) &&
        Objects.equals(this.links, workerStatus.links)&&
        Objects.equals(this.additionalProperties, workerStatus.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workerStatusId, statusType, statusReason, links, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkerStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkerStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkerStatus>() {
           ...
           public WorkerStatus read(JsonReader in) throws IOException {
             ...
             WorkerStatus instance = thisAdapter.fromJsonTree(jsonObj);
