 ...
 */
@ApiModel(description = "The Authentication Response")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Authentication {
  ...
  **/
  ...
  @ApiModelProperty(example = "99f9c30a-8134-4a30-a789-7c7665add41e", value = "The token which will be used for making future calls.")
  ...
  public Authentication expiresIn(String expiresIn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "600", value = "Number of seconds remaining before the token expires.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "oob", value = "This will always return 'oob' (out of band) based on OAuth configuration.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Bearer", value = "This will always return 'Bearer' based on OAuth configuration.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessToken, expiresIn, scope, tokenType, additionalProperties);
  }
