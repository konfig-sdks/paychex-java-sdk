 ...
 */
@ApiModel(description = "Array of properties which specify communication information associated with an entity.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CommunicationResource {
 ...
 public enum UsageTypeEnum {
  ...
  public CommunicationResource communicationId(String communicationId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "00Z5V9BTINBT97UMERCA", value = "The unique ID associated with communication ")
  ...
  public CommunicationResource type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "STREET_ADDRESS", value = "A set of communication types classifying an instruction that the customer, requester, or subject must comply with in order for the screening to go forward. NOTE: PHONE and EMAIL type supports BUSINESS and PERSONAL usage type only.MOBILE_PHONE, FAX and PAGER supports BUSINESS usage type only.This data field cannot be PATCHED.")
  ...
  public CommunicationResource usageType(UsageTypeEnum usageType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "BUSINESS", value = "A code classifying a designated use associated with a contact method. For example, whether a telephone or email address is one for business communications or one primarily for personal use.This data field cannot be PATCHED.")
  ...
  public CommunicationResource dialCountry(String dialCountry) {
  ...
  **/
  ...
  public CommunicationResource dialArea(String dialArea) {
  ...
  **/
  ...
  public CommunicationResource dialNumber(String dialNumber) {
  ...
  **/
  ...
  public CommunicationResource dialExtension(String dialExtension) {
  ...
  **/
  ...
  public CommunicationResource uri(String uri) {
  ...
  **/
  ...
  public CommunicationResource streetLineOne(String streetLineOne) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Mike St", value = "The street address line one")
  ...
  public CommunicationResource streetLineTwo(String streetLineTwo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Sulley Ln", value = "The street address line two")
  ...
  public CommunicationResource postOfficeBox(String postOfficeBox) {
  ...
  **/
  ...
  public CommunicationResource city(String city) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ANAHEIM", value = "The city name")
  ...
  public CommunicationResource postalCode(String postalCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "92802", value = "The zip-code")
  ...
  public CommunicationResource postalCodeExtension(String postalCodeExtension) {
  ...
  **/
  ...
  public CommunicationResource countrySubdivisionCode(String countrySubdivisionCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CA", value = "The state code (ISO 3166 subdivision code). This data field cannot be PATCHED for ACTIVE worker.")
  ...
  public CommunicationResource countryCode(String countryCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "US", value = "The country code (ISO 3166 alpha-2)")
   ...
   * @return the CommunicationResource instance itself
   */
  public CommunicationResource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CommunicationResource communicationResource = (CommunicationResource) o;
    return Objects.equals(this.communicationId, communicationResource.communicationId) &&
        Objects.equals(this.type, communicationResource.type) &&
        Objects.equals(this.usageType, communicationResource.usageType) &&
        Objects.equals(this.dialCountry, communicationResource.dialCountry) &&
        Objects.equals(this.dialArea, communicationResource.dialArea) &&
        Objects.equals(this.dialNumber, communicationResource.dialNumber) &&
        Objects.equals(this.dialExtension, communicationResource.dialExtension) &&
        Objects.equals(this.uri, communicationResource.uri) &&
        Objects.equals(this.streetLineOne, communicationResource.streetLineOne) &&
        Objects.equals(this.streetLineTwo, communicationResource.streetLineTwo) &&
        Objects.equals(this.postOfficeBox, communicationResource.postOfficeBox) &&
        Objects.equals(this.city, communicationResource.city) &&
        Objects.equals(this.postalCode, communicationResource.postalCode) &&
        Objects.equals(this.postalCodeExtension, communicationResource.postalCodeExtension) &&
        Objects.equals(this.countrySubdivisionCode, communicationResource.countrySubdivisionCode) &&
        Objects.equals(this.countryCode, communicationResource.countryCode)&&
        Objects.equals(this.additionalProperties, communicationResource.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(communicationId, type, usageType, dialCountry, dialArea, dialNumber, dialExtension, uri, streetLineOne, streetLineTwo, postOfficeBox, city, postalCode, postalCodeExtension, countrySubdivisionCode, countryCode, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CommunicationResource {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CommunicationResource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CommunicationResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommunicationResource is not found in the empty JSON string", CommunicationResource.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommunicationResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommunicationResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommunicationResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommunicationResource.class));

       return (TypeAdapter<T>) new TypeAdapter<CommunicationResource>() {
           @Override
           public void write(JsonWriter out, CommunicationResource value) throws IOException {
           ...
           @Override
           public CommunicationResource read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CommunicationResource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CommunicationResource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CommunicationResource
  * @throws IOException if the JSON string is invalid with respect to CommunicationResource
  */
  public static CommunicationResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommunicationResource.class);
  }

 /**
  * Convert an instance of CommunicationResource to an JSON string
  *
  * @return JSON string
  */
