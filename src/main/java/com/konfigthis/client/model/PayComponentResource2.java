 ...
 */
@ApiModel(description = "Informational pay components on the check.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PayComponentResource2 {
 ...
 public enum AppliesToWorkerTypesEnum {
  ...
  public PayComponentResource2() {
  }

  
  public PayComponentResource2(
     String componentId, 
     String checkComponentId
  ) {
    this();
  ...
  public PayComponentResource2 description(String description) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "970000053577899", value = "The identifier of the pay component to add to the check. An overtime pay component can't be placed on a worker that is OT exempt.")
  ...
  **/
  ...
  public PayComponentResource2 name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name given to the pay component")
  ...
  public PayComponentResource2 classificationType(String classificationType) {
  ...
  **/
  ...
  public PayComponentResource2 effectOnPay(EffectOnPayEnum effectOnPay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The effect that the pay component will have on the check amount.")
  ...
  public PayComponentResource2 startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public PayComponentResource2 endDate(OffsetDateTime endDate) {
  ...
  **/
  ...
  public PayComponentResource2 appliesToWorkerTypes(List<AppliesToWorkerTypesEnum> appliesToWorkerTypes) {
  ...
  public PayComponentResource2 addAppliesToWorkerTypesItem(AppliesToWorkerTypesEnum appliesToWorkerTypesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Applies To WorkerTypes.")
  ...
  public PayComponentResource2 jobId(String jobId) {
  ...
  **/
  ...
  public PayComponentResource2 laborAssignmentId(String laborAssignmentId) {
  ...
  **/
  ...
  public PayComponentResource2 payRateId(String payRateId) {
  ...
  **/
  ...
  public PayComponentResource2 payRate(String payRate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The rate amount that will be applied for this component. Used in conjunction with Hours or Units.")
  ...
  public PayComponentResource2 payHours(String payHours) {
  ...
  **/
  ...
  public PayComponentResource2 payUnits(String payUnits) {
  ...
  **/
  ...
  public PayComponentResource2 payAmount(String payAmount) {
  ...
  **/
  ...
  public PayComponentResource2 memoed(Boolean memoed) {
  ...
  **/
  ...
  public PayComponentResource2 lineDate(OffsetDateTime lineDate) {
  ...
  **/
   ...
   * @return the PayComponentResource2 instance itself
   */
  public PayComponentResource2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayComponentResource2 payComponentResource2 = (PayComponentResource2) o;
    return Objects.equals(this.description, payComponentResource2.description) &&
        Objects.equals(this.componentId, payComponentResource2.componentId) &&
        Objects.equals(this.checkComponentId, payComponentResource2.checkComponentId) &&
        Objects.equals(this.name, payComponentResource2.name) &&
        Objects.equals(this.classificationType, payComponentResource2.classificationType) &&
        Objects.equals(this.effectOnPay, payComponentResource2.effectOnPay) &&
        Objects.equals(this.startDate, payComponentResource2.startDate) &&
        Objects.equals(this.endDate, payComponentResource2.endDate) &&
        Objects.equals(this.appliesToWorkerTypes, payComponentResource2.appliesToWorkerTypes) &&
        Objects.equals(this.jobId, payComponentResource2.jobId) &&
        Objects.equals(this.laborAssignmentId, payComponentResource2.laborAssignmentId) &&
        Objects.equals(this.payRateId, payComponentResource2.payRateId) &&
        Objects.equals(this.payRate, payComponentResource2.payRate) &&
        Objects.equals(this.payHours, payComponentResource2.payHours) &&
        Objects.equals(this.payUnits, payComponentResource2.payUnits) &&
        Objects.equals(this.payAmount, payComponentResource2.payAmount) &&
        Objects.equals(this.memoed, payComponentResource2.memoed) &&
        Objects.equals(this.lineDate, payComponentResource2.lineDate)&&
        Objects.equals(this.additionalProperties, payComponentResource2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, componentId, checkComponentId, name, classificationType, effectOnPay, startDate, endDate, appliesToWorkerTypes, jobId, laborAssignmentId, payRateId, payRate, payHours, payUnits, payAmount, memoed, lineDate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayComponentResource2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayComponentResource2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayComponentResource2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayComponentResource2 is not found in the empty JSON string", PayComponentResource2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayComponentResource2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayComponentResource2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayComponentResource2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayComponentResource2.class));

       return (TypeAdapter<T>) new TypeAdapter<PayComponentResource2>() {
           @Override
           public void write(JsonWriter out, PayComponentResource2 value) throws IOException {
           ...
           @Override
           public PayComponentResource2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayComponentResource2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayComponentResource2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayComponentResource2
  * @throws IOException if the JSON string is invalid with respect to PayComponentResource2
  */
  public static PayComponentResource2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayComponentResource2.class);
  }

 /**
  * Convert an instance of PayComponentResource2 to an JSON string
  *
  * @return JSON string
  */
