...
public class WorkerResource1 {
 ...
 public enum SexEnum {
  ...
  private List<CommunicationResource1> communications = null;
  ...
  public WorkerResource1() {
  }

  public WorkerResource1 workerId(String workerId) {
  ...
  **/
  ...
  public WorkerResource1 employeeId(String employeeId) {
  ...
  **/
  ...
  public WorkerResource1 workerType(WorkerTypeEnum workerType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "EMPLOYEE", value = "The type of worker. This data field cannot be PATCHED.")
  ...
  public WorkerResource1 employmentType(EmploymentTypeEnum employmentType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "FULL_TIME", value = "The type of employment for the worker.")
  ...
  public WorkerResource1 exemptionType(ExemptionTypeEnum exemptionType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "NON_EXEMPT", value = "The Overtime classification of the worker. This data field cannot be PATCHED for ACTIVE workers.")
  ...
  public WorkerResource1 birthDate(OffsetDateTime birthDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1988-07-01T00:00Z", value = "The workers date of birth. It cannot be greater than today's date.")
  ...
  public WorkerResource1 sex(SexEnum sex) {
  ...
  **/
  ...
  public WorkerResource1 ethnicityCode(String ethnicityCode) {
  ...
  **/
  ...
  public WorkerResource1 hireDate(OffsetDateTime hireDate) {
  ...
  **/
  ...
  public WorkerResource1 clockId(String clockId) {
  ...
  **/
  ...
  public WorkerResource1 name(NameResource1 name) {
  ...
  **/
  ...
  public WorkerResource1 legalId(LegalIdResource1 legalId) {
  ...
  **/
  ...
  public LegalIdResource1 getLegalId() {
    return legalId;
  }


  public void setLegalId(LegalIdResource1 legalId) {
  ...
  public WorkerResource1 laborAssignmentId(String laborAssignmentId) {
  ...
  **/
  ...
  public WorkerResource1 locationId(String locationId) {
  ...
  **/
  ...
  public WorkerResource1 jobId(String jobId) {
  ...
  **/
  ...
  public WorkerResource1 job(JobTitleResource1 job) {
  ...
  **/
  ...
  public JobTitleResource1 getJob() {
    return job;
  }


  public void setJob(JobTitleResource1 job) {
  ...
  public WorkerResource1 organization(OrganizationResource1 organization) {
  ...
  **/
  ...
  public OrganizationResource1 getOrganization() {
    return organization;
  }


  public void setOrganization(OrganizationResource1 organization) {
  ...
  public WorkerResource1 supervisor(SupervisorResource1 supervisor) {
  ...
  **/
  ...
  public SupervisorResource1 getSupervisor() {
    return supervisor;
  }


  public void setSupervisor(SupervisorResource1 supervisor) {
  ...
  public WorkerResource1 currentStatus(Status1 currentStatus) {
  ...
  **/
  ...
  public Status1 getCurrentStatus() {
    return currentStatus;
  }


  public void setCurrentStatus(Status1 currentStatus) {
  ...
  public WorkerResource1 communications(List<CommunicationResource1> communications) {
  ...
  public WorkerResource1 addCommunicationsItem(CommunicationResource1 communicationsItem) {
  ...
  **/
  ...
  public List<CommunicationResource1> getCommunications() {
    return communications;
  }


  public void setCommunications(List<CommunicationResource1> communications) {
  ...
  public WorkerResource1 links(List<Link> links) {
  ...
  public WorkerResource1 addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public WorkerResource1 workerCorrelationId(String workerCorrelationId) {
  ...
  **/
   ...
   * @return the WorkerResource1 instance itself
   */
  public WorkerResource1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkerResource1 workerResource1 = (WorkerResource1) o;
    return Objects.equals(this.workerId, workerResource1.workerId) &&
        Objects.equals(this.employeeId, workerResource1.employeeId) &&
        Objects.equals(this.workerType, workerResource1.workerType) &&
        Objects.equals(this.employmentType, workerResource1.employmentType) &&
        Objects.equals(this.exemptionType, workerResource1.exemptionType) &&
        Objects.equals(this.birthDate, workerResource1.birthDate) &&
        Objects.equals(this.sex, workerResource1.sex) &&
        Objects.equals(this.ethnicityCode, workerResource1.ethnicityCode) &&
        Objects.equals(this.hireDate, workerResource1.hireDate) &&
        Objects.equals(this.clockId, workerResource1.clockId) &&
        Objects.equals(this.name, workerResource1.name) &&
        Objects.equals(this.legalId, workerResource1.legalId) &&
        Objects.equals(this.laborAssignmentId, workerResource1.laborAssignmentId) &&
        Objects.equals(this.locationId, workerResource1.locationId) &&
        Objects.equals(this.jobId, workerResource1.jobId) &&
        Objects.equals(this.job, workerResource1.job) &&
        Objects.equals(this.organization, workerResource1.organization) &&
        Objects.equals(this.supervisor, workerResource1.supervisor) &&
        Objects.equals(this.currentStatus, workerResource1.currentStatus) &&
        Objects.equals(this.communications, workerResource1.communications) &&
        Objects.equals(this.links, workerResource1.links) &&
        Objects.equals(this.workerCorrelationId, workerResource1.workerCorrelationId)&&
        Objects.equals(this.additionalProperties, workerResource1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workerId, employeeId, workerType, employmentType, exemptionType, birthDate, sex, ethnicityCode, hireDate, clockId, name, legalId, laborAssignmentId, locationId, jobId, job, organization, supervisor, currentStatus, communications, links, workerCorrelationId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WorkerResource1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkerResource1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkerResource1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkerResource1 is not found in the empty JSON string", WorkerResource1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("legalId") != null && !jsonObj.get("legalId").isJsonNull()) {
        LegalIdResource1.validateJsonObject(jsonObj.getAsJsonObject("legalId"));
      }
      ...
      if (jsonObj.get("job") != null && !jsonObj.get("job").isJsonNull()) {
        JobTitleResource1.validateJsonObject(jsonObj.getAsJsonObject("job"));
      }
      // validate the optional field `organization`
      if (jsonObj.get("organization") != null && !jsonObj.get("organization").isJsonNull()) {
        OrganizationResource1.validateJsonObject(jsonObj.getAsJsonObject("organization"));
      }
      // validate the optional field `supervisor`
      if (jsonObj.get("supervisor") != null && !jsonObj.get("supervisor").isJsonNull()) {
        SupervisorResource1.validateJsonObject(jsonObj.getAsJsonObject("supervisor"));
      }
      // validate the optional field `currentStatus`
      if (jsonObj.get("currentStatus") != null && !jsonObj.get("currentStatus").isJsonNull()) {
        Status1.validateJsonObject(jsonObj.getAsJsonObject("currentStatus"));
      }
      if (jsonObj.get("communications") != null && !jsonObj.get("communications").isJsonNull()) {
        ...
        if (jsonArraycommunications != null) {
          ...
          for (int i = 0; i < jsonArraycommunications.size(); i++) {
            CommunicationResource1.validateJsonObject(jsonArraycommunications.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkerResource1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkerResource1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkerResource1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkerResource1.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkerResource1>() {
           @Override
           public void write(JsonWriter out, WorkerResource1 value) throws IOException {
           ...
           @Override
           public WorkerResource1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkerResource1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkerResource1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkerResource1
  * @throws IOException if the JSON string is invalid with respect to WorkerResource1
  */
  public static WorkerResource1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkerResource1.class);
  }

 /**
  * Convert an instance of WorkerResource1 to an JSON string
  *
  * @return JSON string
  */
