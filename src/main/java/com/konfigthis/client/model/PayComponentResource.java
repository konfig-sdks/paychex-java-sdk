 ...
 */
@ApiModel(description = "The earnings to apply to the check. Each earning needs to define as one of the following allowed values")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PayComponentResource {
 ...
 public enum EffectOnPayEnum {
   ...
   */
  @JsonAdapter(AppliesToWorkerTypesEnum.Adapter.class)
 public enum AppliesToWorkerTypesEnum {
    EMPLOYEE("EMPLOYEE"),
    ...
    AppliesToWorkerTypesEnum(String value) {
      this.value = value;
    }
    ...
    public static AppliesToWorkerTypesEnum fromValue(String value) {
      for (AppliesToWorkerTypesEnum b : AppliesToWorkerTypesEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<AppliesToWorkerTypesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AppliesToWorkerTypesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AppliesToWorkerTypesEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AppliesToWorkerTypesEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_APPLIES_TO_WORKER_TYPES = "appliesToWorkerTypes";
  @SerializedName(SERIALIZED_NAME_APPLIES_TO_WORKER_TYPES)
  private List<AppliesToWorkerTypesEnum> appliesToWorkerTypes = null;
  ...
  public PayComponentResource() {
  }

  public PayComponentResource description(String description) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Use for regular pay.", value = "The description of the Pay Component.")
  ...
  public PayComponentResource componentId(String componentId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "970000076689381", value = "The unique identifier used to identify a pay component.")
  ...
  public PayComponentResource checkComponentId(String checkComponentId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique identifier associated for the pay component on this check.")
  ...
  public PayComponentResource code(String code) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The Paychex standard code number for the Pay Component, can be two digit.")
  ...
  public PayComponentResource name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Hourly", value = "Name given to the pay component.")
  ...
  public PayComponentResource classificationType(String classificationType) {
  ...
  **/
  ...
  public PayComponentResource effectOnPay(EffectOnPayEnum effectOnPay) {
  ...
  **/
  ...
  public PayComponentResource startDate(OffsetDateTime startDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2016-01-01T00:00Z", value = "The date that the pay component is able to be applied on a check.")
  ...
  public PayComponentResource endDate(OffsetDateTime endDate) {
  ...
  **/
  ...
  public PayComponentResource appliesToWorkerTypes(List<AppliesToWorkerTypesEnum> appliesToWorkerTypes) {
  ...
  public PayComponentResource addAppliesToWorkerTypesItem(AppliesToWorkerTypesEnum appliesToWorkerTypesItem) {
    if (this.appliesToWorkerTypes == null) {
      this.appliesToWorkerTypes = new ArrayList<>();
    }
    this.appliesToWorkerTypes.add(appliesToWorkerTypesItem);
    return this;
  }

   /**
   * List of workerTypes that the component can be applied to.
   * @return appliesToWorkerTypes
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of workerTypes that the component can be applied to.")

  public List<AppliesToWorkerTypesEnum> getAppliesToWorkerTypes() {
    return appliesToWorkerTypes;
  }


  public void setAppliesToWorkerTypes(List<AppliesToWorkerTypesEnum> appliesToWorkerTypes) {
  ...
  public PayComponentResource jobId(String jobId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This is used optionally for overriding a job when it needs to be different than the workers default. This option is only available when the client has job costing.")
  ...
  public PayComponentResource laborAssignmentId(String laborAssignmentId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This is used optionally for overriding a labor assignment when it needs to be different than the workers assignment distribution. This option is only available when the client has labor assignment.")
  ...
  public PayComponentResource payRateId(String payRateId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unique identifier for this workers pay rate **This ID will change if this is created for an IN_PROGRESS worker that is later completed within Flex**")
  ...
  public PayComponentResource payRate(String payRate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "7.25", value = "The rate amount that will be applied for this component. Used in conjunction with Hours or Units.")
  ...
  public PayComponentResource payHours(String payHours) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4", value = "The number of hours that will be applied for this component. Used in conjunction with rate.")
  ...
  public PayComponentResource payUnits(String payUnits) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of units that will be applied for this component. Used in conjunction with rate.")
  ...
  public PayComponentResource payAmount(String payAmount) {
  ...
  **/
  ...
  public PayComponentResource lineDate(OffsetDateTime lineDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This is used optionally for specifying a date that the pay component was generated on.")
  ...
  public PayComponentResource memoed(Boolean memoed) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "This is used optionally for memoing the payHours or payUnits so that they are informational when using a payAmount.")
  ...
  public PayComponentResource links(List<Link> links) {
  ...
  public PayComponentResource addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
   ...
   * @return the PayComponentResource instance itself
   */
  public PayComponentResource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayComponentResource payComponentResource = (PayComponentResource) o;
    return Objects.equals(this.description, payComponentResource.description) &&
        Objects.equals(this.componentId, payComponentResource.componentId) &&
        Objects.equals(this.checkComponentId, payComponentResource.checkComponentId) &&
        Objects.equals(this.code, payComponentResource.code) &&
        Objects.equals(this.name, payComponentResource.name) &&
        Objects.equals(this.classificationType, payComponentResource.classificationType) &&
        Objects.equals(this.effectOnPay, payComponentResource.effectOnPay) &&
        Objects.equals(this.startDate, payComponentResource.startDate) &&
        Objects.equals(this.endDate, payComponentResource.endDate) &&
        Objects.equals(this.appliesToWorkerTypes, payComponentResource.appliesToWorkerTypes) &&
        Objects.equals(this.jobId, payComponentResource.jobId) &&
        Objects.equals(this.laborAssignmentId, payComponentResource.laborAssignmentId) &&
        Objects.equals(this.payRateId, payComponentResource.payRateId) &&
        Objects.equals(this.payRate, payComponentResource.payRate) &&
        Objects.equals(this.payHours, payComponentResource.payHours) &&
        Objects.equals(this.payUnits, payComponentResource.payUnits) &&
        Objects.equals(this.payAmount, payComponentResource.payAmount) &&
        Objects.equals(this.lineDate, payComponentResource.lineDate) &&
        Objects.equals(this.memoed, payComponentResource.memoed) &&
        Objects.equals(this.links, payComponentResource.links)&&
        Objects.equals(this.additionalProperties, payComponentResource.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, componentId, checkComponentId, code, name, classificationType, effectOnPay, startDate, endDate, appliesToWorkerTypes, jobId, laborAssignmentId, payRateId, payRate, payHours, payUnits, payAmount, lineDate, memoed, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayComponentResource {\n");
    ...
    sb.append("    appliesToWorkerTypes: ").append(toIndentedString(appliesToWorkerTypes)).append("\n");
  ...
  static {
    ...
    openapiFields.add("appliesToWorkerTypes");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayComponentResource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayComponentResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayComponentResource is not found in the empty JSON string", PayComponentResource.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("appliesToWorkerTypes") != null && !jsonObj.get("appliesToWorkerTypes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `appliesToWorkerTypes` to be an array in the JSON string but got `%s`", jsonObj.get("appliesToWorkerTypes").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayComponentResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayComponentResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayComponentResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayComponentResource.class));

       return (TypeAdapter<T>) new TypeAdapter<PayComponentResource>() {
           @Override
           public void write(JsonWriter out, PayComponentResource value) throws IOException {
           ...
           @Override
           public PayComponentResource read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayComponentResource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayComponentResource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayComponentResource
  * @throws IOException if the JSON string is invalid with respect to PayComponentResource
  */
  public static PayComponentResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayComponentResource.class);
  }

 /**
  * Convert an instance of PayComponentResource to an JSON string
  *
  * @return JSON string
  */
